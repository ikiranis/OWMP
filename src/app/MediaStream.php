...
/**
 *
 * File: MediaStream.php
 *
 * @author Rana
 * @link http://codesamplez.com/programming/php-html5-video-streaming-tutorial
 *
 *
 * Steamάρει ένα media αρχείο (audio/video)
 *
 * Προστέθηκε στο αρχικό source η δυνατότητα να βρίσκει μόνο του το mime type, αντί να είναι μόνο για video/mp4
 *
 */
